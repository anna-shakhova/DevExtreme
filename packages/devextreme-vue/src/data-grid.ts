...
(DxDataGridToolbarItem as any).$_optionName = "items";
(DxDataGridToolbarItem as any).$_isCollectionItem = true;
...
const DxItemConfig = {
  ...
  props: {
    ...
    location: String as PropType<ToolbarItemLocation>,
    menuItemTemplate: {},
    name: String as PropType<string | FormPredefinedButtonItem | DataGridPredefinedToolbarItem>,
    options: {},
    showText: String as PropType<ShowTextMode>,
